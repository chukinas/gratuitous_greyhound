defmodule Spatial.PositionOrientationSize do

  use Spatial.Math
  use Spatial.PositionOrientationSize.Types
  require Spatial.PositionOrientationSize.Guards
  import Spatial.PositionOrientationSize.Guards
  alias Spatial.Math
  alias Spatial.PositionOrientationSize.IsPos
  alias Spatial.PositionOrientationSize.Pose
  alias Spatial.PositionOrientationSize.PoseApi
  alias Spatial.PositionOrientationSize.Position
  alias Spatial.PositionOrientationSize.Size
  alias Util.Maps
