alias Spatial.Geometry.{GridSquare, Rect}
alias Dreadnought.Paths

defmodule Dreadnought.GridSquare do
  @moduledoc"""
...
defimpl Spatial.BoundingRect, for: GridSquare do
...
defimpl Spatial.Collide.IsShape, for: GridSquare do
  def to_coords(grid_square) do
    grid_square
    |> Spatial.BoundingRect.of
    |> Rect.to_coords
  end
end
