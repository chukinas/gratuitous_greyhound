...
alias Dreadnought.Grid

defimpl Spatial.BoundingRect, for: Grid do
    use Spatial.PositionOrientationSize
...
defimpl Spatial.Collide.IsShape, for: Grid do
  alias Spatial.Geometry.Rect
